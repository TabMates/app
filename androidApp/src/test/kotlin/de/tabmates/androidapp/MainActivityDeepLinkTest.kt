...
class MainActivityDeepLinkTest {
    ...
    fun onCreate_withDeepLinkIntent_forwardsUriToHandler() {
        ...
        val intent =
            Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://app.tabmates.de/verify/abc123"),
            )
        ...
        assertEquals("https://app.tabmates.de/verify/abc123", received)
    }
    ...
    fun onNewIntent_forwardsUriToHandler() {
        ...
        val newIntent =
            Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://app.tabmates.de/reset-password/xyz789"),
            )
        activityController.newIntent(newIntent)

        assertEquals("https://app.tabmates.de/reset-password/xyz789", received)
    }

    // region — custom tabmates:// scheme (matches second intent-filter in AndroidManifest)

    @Test
    fun onCreate_withTabmatesSchemeVerify_forwardsUriToHandler() {
        var received: String? = null
        DeepLinkHandler.listener = { received = it }
        ...
        val intent =
            Intent(
                Intent.ACTION_VIEW,
                Uri.parse("tabmates://app.tabmates.de/verify/abc123"),
            )
        ...
        assertEquals("tabmates://app.tabmates.de/verify/abc123", received)
    }

    @Test
    fun onCreate_withTabmatesSchemeResetPassword_forwardsUriToHandler() {
        var received: String? = null
        DeepLinkHandler.listener = { received = it }
        ...
        val intent =
            Intent(
                Intent.ACTION_VIEW,
                Uri.parse("tabmates://app.tabmates.de/reset-password/xyz789"),
            )
        ...
        assertEquals("tabmates://app.tabmates.de/reset-password/xyz789", received)
    }

    @Test
    fun onNewIntent_withTabmatesScheme_forwardsUriToHandler() {
        var received: String? = null
