...
include(":features:appupdate:data")
include(":features:appupdate:domain")
...
include(":features:notifications:data")
include(":features:notifications:domain")
include(":features:notifications:testing")
...
include(":features:tabgroup:sqliteWasmWorker")
