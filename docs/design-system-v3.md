...
|---|---|---|---|
| `primary` | `#8F4B3A` | `#FFB4A2` | Key CTAs, active nav indicator, FAB |
| `onPrimary` | `#FFFFFF` | `#561F11` | Text/icons on `primary` |
| `primaryContainer` | `#FFDBD2` | `#723524` | Chips, selected cards, prominent surface zones |
| `onPrimaryContainer` | `#723524` | `#FFDBD2` | Text/icons on `primaryContainer` |
| `secondary` | `#8C4A5F` | `#FFB1C7` | Tags, category indicators, secondary actions |
| `onSecondary` | `#FFFFFF` | `#551D31` | Text/icons on `secondary` |
| `secondaryContainer` | `#FFD9E2` | `#703347` | Filter chips, balance indicator backgrounds |
| `onSecondaryContainer` | `#703347` | `#FFD9E2` | Text/icons on `secondaryContainer` |
| `tertiary` | `#116B57` | `#87D6BD` | Accent highlights, settlement badges, special moments |
| `onTertiary` | `#FFFFFF` | `#00382C` | Text/icons on `tertiary` |
| `tertiaryContainer` | `#A2F2D8` | `#005140` | Stat callout cards, decorative highlights |
| `onTertiaryContainer` | `#005140` | `#A2F2D8` | Text/icons on `tertiaryContainer` |
...
| Token | Value | Usage |
|---|---|---|
| `primaryFixed` | `#FFDBD2` | Persistent primary-toned surface |
| `primaryFixedDim` | `#FFB4A2` | Slightly dimmer fixed primary (hover/pressed on fixed surfaces) |
| `onPrimaryFixed` | `#723524` | Text/icons on `primaryFixed` |
| `onPrimaryFixedVariant` | `#723524` | Secondary text/icons on `primaryFixed` (lower emphasis) |
| `secondaryFixed` | `#FFD9E2` | Persistent secondary-toned surface |
| `secondaryFixedDim` | `#FFB1C7` | Dimmer fixed secondary |
| `onSecondaryFixed` | `#703347` | Text/icons on `secondaryFixed` |
| `onSecondaryFixedVariant` | `#703347` | Secondary text/icons on `secondaryFixed` |
| `tertiaryFixed` | `#A2F2D8` | Persistent tertiary-toned surface |
| `tertiaryFixedDim` | `#87D6BD` | Dimmer fixed tertiary |
| `onTertiaryFixed` | `#005140` | Text/icons on `tertiaryFixed` |
...
|---|---|---|---|
| `background` | `#FFF8F6` | `#1A110F` | App background (behind all content) |
| `onBackground` | `#231917` | `#F1DFDA` | Text/icons on `background` |
| `surface` | `#FFF8F6` | `#1A110F` | Base surface (equals `background` in M3) |
| `onSurface` | `#231917` | `#F1DFDA` | Primary text/icons on `surface` |
| `surfaceVariant` | `#F5DDD8` | `#53433F` | Kept for backward compatibility; prefer container tiers below |
| `onSurfaceVariant` | `#53433F` | `#D8C2BC` | Secondary text/icons, subtitle text |
| `surfaceContainerLowest` | `#FFFFFF` | `#140C0A` | Lowest-emphasis container (page background inset) |
| `surfaceContainerLow` | `#FFF1ED` | `#231917` | List item backgrounds, subtle grouping |
| `surfaceContainer` | `#FCEAE6` | `#271D1B` | Standard card background |
| `surfaceContainerHigh` | `#F7E4E0` | `#322825` | Elevated cards, selected list items |
| `surfaceContainerHighest` | `#F1DFDA` | `#3D3230` | Top-level modal surfaces, dialogs |
| `surfaceBright` | `#FFF8F6` | `#423734` | Highlighted surface areas (status bar zone, hero sections) |
| `surfaceDim` | `#E8D6D2` | `#1A110F` | Dimmed surface (scrim behind modal overlays) |
| `inverseSurface` | `#392E2B` | `#F1DFDA` | Snackbar background |
| `inverseOnSurface` | `#FFEDE9` | `#392E2B` | Snackbar text |
| `inversePrimary` | `#FFB4A2` | `#8F4B3A` | FAB icon on dark surface |
| `surfaceTint` | `#8F4B3A` | `#FFB4A2` | Tonal elevation overlay color (= `primary`) |
...
| Token | Light Mode | Dark Mode | Usage |
|---|---|---|---|
| `outline` | `#85736F` | `#A08C88` | Borders, dividers, text field outlines |
| `outlineVariant` | `#D8C2BC` | `#53433F` | Subtle dividers, chip outlines |
...
|---|---|---|---|---|
| `positive` | `tertiary` | `#116B57` | `#87D6BD` | User is owed money — **always paired with an icon/label, never color alone** |
| `positiveContainer` | `tertiaryContainer` | `#A2F2D8` | `#005140` | Background for "owed" balance cards |
...
| `settled` | `surfaceContainerHigh` / `onSurfaceVariant` | `#F7E4E0` bg, `#53433F` text | `#322825` bg, `#D8C2BC` text | Debt fully settled — muted/neutral treatment |
| `deleted` | `onSurfaceVariant` @ 60% α | `#53433F` @ 60% | `#D8C2BC` @ 60% | Muted strikethrough treatment for deleted entries |
