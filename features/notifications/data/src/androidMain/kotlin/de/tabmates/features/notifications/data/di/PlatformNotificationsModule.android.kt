...
import de.tabmates.features.notifications.data.AndroidNotificationPermissionController
...
actual class PlatformNotificationsModule {
        ...
        MobilePushNotificationController(
            ...
            config =
                NotificationPlatformConfiguration.Android(
                    // TODO: replace with a branded monochrome notification icon (Res.drawable.ic_notification).
    ...
    @Single
    fun provideNotificationPermissionController(context: Context): NotificationPermissionController =
        AndroidNotificationPermissionController(context)
}
