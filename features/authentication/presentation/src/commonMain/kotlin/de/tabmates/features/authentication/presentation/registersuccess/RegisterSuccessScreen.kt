...
import tabmatesapp.features.authentication.presentation.generated.resources.verification_email_sent_to_x
...
fun RegisterSuccessRoot(
    ...
    RegisterSuccessScreen(
        ...
        onResendVerificationClick = registerSuccessViewModel::resendVerification,
    )
}
...
private fun RegisterSuccessScreen(
    ...
    Column(
        ...
        Text(
            text = stringResource(Res.string.verification_email_sent_to_x, email),
            modifier = Modifier.padding(horizontal = 16.dp),
